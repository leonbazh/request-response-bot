...
bad_words = [ '/' ,',' ,'.', 'бля', 'блядь', 'блять', 'b3ъeб', 'cock', 
             ...
             'чмошник', 'чмырь', 'шалава', 'шалавой', 'шараёбиться', 'шлюха', 'шлюхой', 'шлюшка', 'даун', 'заебись', 'пиdop', 'член', 'гей']
...
def filter_count(phrase):
    if phrase.isdigit() and int(phrase) >= 1 and int(phrase) <=20:
        return True
    else:
        return False
